...
NAMES = {
    ...
    "FN": "Fabrinet", "AAOI": "Applied Optoelectronics", "CRDO": "Credo Tech",
    "TLN": "Talen Energy", "D": "Dominion Energy", "SO": "Southern Company",
    "PEG": "Public Service Enterprise", "ETR": "Entergy",
}
...
SECTOR_META = [
    ...
    ("Fiber Optics & Cabling", "05", "THE GLASS",
     "The physical fiber itself and the systems that light it up: Corning draws the glass, Ciena builds the long-haul optical gear. Slower-moving, more industrial than the transceiver names below.", 1),
    ("Photonics & Optical Interconnect", "06", "PHOTONICS",
     "Light, not electricity, moves data between GPUs. Optical transceivers, lasers, photonic integrated circuits and the interconnect chips that drive them. This is the fastest-growing dollar line inside an AI rack: optics content per GPU rises every hardware generation, and 800G is giving way to 1.6T. Coherent and Lumentum make the lasers and modules, Fabrinet builds them under contract for nearly everyone, Applied Optoelectronics is the smaller US transceiver play, Credo supplies the interconnect silicon. Note this group is more cyclical than the rest of Sheet 1: it lives on hyperscaler order cycles, so drawdowns are sharp. Silicon-photonics micro-caps (POET and similar) are deliberately not on the board: too small and too pre-revenue for a long-term sheet.", 1),
    ("Electrical, Conduit & Steel", "07", "ELECTRIFICATION",
     "The unglamorous physical layer: switchgear, steel conduit, cable tray, wire distribution and the steel it is made from.", 1),
    ("Nuclear Infrastructure & Power Majors", "08", "POWER",
