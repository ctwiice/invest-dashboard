...
SECTOR_META = [
    ("Semiconductors & Fab", "01", "SILICON",
     "GPU and chip designers plus the fabs and lithography machines that make them. The top of the stack: highest margins, highest expectations. Intel carries a GOV badge: Washington owns roughly 10% of it.", 1),
    ("Memory & Storage", "02", "MEMORY",
    ...
    ("Servers, Cooling & Networking", "03", "COMPUTE RACKS",
     "The chips have to live somewhere. Server builders, liquid cooling and power management, and the switches that connect racks together.", 1),
    ("Fiber Optics & Photonics", "04", "INTERCONNECT",
    ...
    ("Big Tech & Hyperscalers", "07", "THE CUSTOMERS",
    ...
    ("Healthcare & Pharma", "08", "OUTSIDE THE THEME",
